  ...
  return (
    <>
      ...
      <ParticlesScreen
        particlesCount={75}
      />
        <section className='py-5 px-10 bg-zinc-900 rounded-xl flex flex-col shadow-lg shadow-red-800/70 relative'>
          <section className='flex justify-start flex-col lg:flex-row items-center'>
              <img src="/socialicon.jpg" className='w-[200px] h-[200px] grayscale-100 shadow-lg shadow-red-800' alt='Kamil Kijak profile picture' role="image"/>
              <section className='flex-1/3 lg:ml-10'>
                <section className='flex items-center flex-col lg:flex-row lg:mt-0 mt-4'>
                  <h1 className='text-3xl font-bold text-red-800 lg:mt-0 mt-5'>Kamil Kijak</h1>
                ...
                <section className='flex flex-col xl:flex-row mt-4 lg:ml-3 xl:items-center lg:items-start items-center justify-center lg:justify-start gap-y-3'>
                  ...
                  <a href="mailto:kamil.kijak@pixlesofte.com" title="e-mail" className=" text-white border-b-transparent hover:border-b-red-800 border-b-4 font-bold xl:ml-7 transition-colors duration-300" aria-label="email adress"><FontAwesomeIcon icon={faEnvelope}/> kamil.kijak@pixlesofte.com</a>
                </section>
              ...
              <section className='flex-1/3 flex flex-col items-center lg:mb-0 mb-4'>
                <section className='flex flex-col lg:items-start items-center' aria-label="social links" role="list">
                  <h1 className='text-3xl font-bold text-red-800 mb-5'>{getTextByKey("social")}</h1>
            ...
            <section className='mt-3 flex flex-col items-center'>
              <div className='h-3 w-[250px] bg-red-800 rounded-2xl'></div>
          ...
          <BrowserRouter>
            <section className='pb-5 bg-zinc-900 rounded-xl flex flex-col mt-20 overflow-hidden min-h-[100vh] shadow-lg shadow-red-800/70 relative'>
              <nav className='flex justify-start items-center border-b-4 border-red-800 flex-wrap' aria-label="navigation">
