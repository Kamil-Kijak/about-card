        ...
        <section className="flex mt-8 justify-center items-start min-h-full pb-5">
            <section className="flex justify-around w-full mt-10 lg:flex-row flex-col gap-y-10">
                <section className="flex flex-col items-center flex-1/2">
                    ...
                    <p className="text-white text-xl lg:w-[50%] w-[75%] text-center mt-4">
                ...
                <section className="flex-1/4 flex flex-col items-center">
                    ...
                    <section className="flex flex-col items-start text-white font-bold mt-7 text-2xl gap-y-3">
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Productive"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Creative"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Self-improvement"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Problem solving"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Logical thinking"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Helper"}/>
                        <TextListItem title={<div className="bg-cyan-400 w-[1rem] h-[1rem] rounded-full"></div>} text={"Teamwork"}/>
                    </section>
                </section>
            </section>
        </section>
