...
export default function Projects({}) {
    ...
    return (
        <section className="flex lg:flex-row flex-col mt-8 md:justify-around justify-center items-center min-h-full flex-1">
            ...
            <section className="grid lg:grid-cols-2 grid-cols-1 w-full sm:w-[75%] md:w-full p-5 gap-4 items-stretch lg:h-[800px] overflow-auto scrollbar lg:max-w-screen md:max-w-[500px] max-w-screen" aria-label="Project list" role="grid">
            ...
            <section ref={descRef} className=" w-full flex flex-col items-center lg:mt-0 overflow-y-auto lg:h-[800px] h-full scrollbar self-start pt-20" role="description">
